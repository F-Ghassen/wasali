...
export default function SignUpDriverScreen() {
  ...
  const onSubmit = async (data: SignUpData) => {
    try {
      await signUp(data.email, data.password, data.fullName, 'driver');
  ...
  return (
    ...
    >
      ...
      >
        <Text style={styles.title}>Join as a Traveller</Text>
        <Text style={styles.subtitle}>Earn money by carrying packages to Tunisia on your trips</Text>
