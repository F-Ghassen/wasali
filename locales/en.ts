export default {
  ...
  roleGuard: {
    ...
    driverOnly: 'This section is for registered drivers only. Your account is set up as a sender.',
    senderOnly: 'This section is for senders. Your account is set up as a driver.',
  ...
  routeDetail: {
    ...
    alerts: {
      ...
      cannotCancelMsg: 'This route has confirmed or in-transit bookings. Please resolve them before cancelling.',
      cancelTitle: 'Cancel Route',
      cancelMsg: 'Are you sure you want to cancel this route? This cannot be undone.',
  ...
  routeWizard: {
    ...
    dropoff: {
      ...
      arrivalLabel: 'Estimated arrival (optional)',
      meetingPointLabel: 'Meeting point link (optional)',
    ...
    logistics: {
      ...
      dropoffDesc: 'Sender brings packages to an agreed meeting point before departure.',
      homePickup: 'Home pick-up by driver',
      homePickupDesc: "You collect the package directly from the sender's address.",
      recipientCollects: 'Recipient collects',
      recipientCollectsDesc: 'Recipient picks up from a drop-off point in the destination city.',
      homeDelivery: 'Home delivery by driver',
      homeDeliveryDesc: "You deliver the package directly to the recipient's door.",
    },
    notes: {
      title: 'Notes & Rules',
    ...
    pricing: {
      ...
      errors: {
        ...
        duplicateMsg: 'You already have a route on this corridor for this date.',
      },
      toast: {
  ...
  booking: {
    ...
    collection: {
      ...
      dropoffDesc: 'Bring to a shared collection point. Exact address & time confirmed after booking.',
  ...
  status: {
    pending: { label: 'Awaiting Driver', desc: 'Waiting for the driver to confirm your booking' },
    confirmed: { label: 'Confirmed', desc: 'Your booking is confirmed and scheduled' },
  ...
  tracking: {
    ...
    pendingBanner: "Awaiting driver confirmation — you'll be notified once the driver accepts.",
    steps: {
    ...
    insufficientCapacity: 'Not enough capacity on this route. Booking reverted to pending.',
