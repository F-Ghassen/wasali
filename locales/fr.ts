export default {
  ...
  roleGuard: {
    ...
    driverOnly:
      "Cette section est réservée aux conducteurs enregistrés. Votre compte est configuré en tant qu'expéditeur.",
    senderOnly:
      "Cette section est réservée aux expéditeurs. Votre compte est configuré en tant que conducteur.",
  ...
  driverRoutes: {
    ...
    emptyDesc:
      "Créez votre premier trajet pour commencer à accepter des colis.",
  },
  ...
  routeWizard: {
    ...
    logistics: {
      ...
      dropoffDesc:
        "L'expéditeur apporte les colis à un point de rendez-vous convenu avant le départ.",
      homePickup: "Collecte à domicile par le conducteur",
      homePickupDesc:
        "Vous collectez le colis directement à l'adresse de l'expéditeur.",
      recipientCollects: "Retrait par le destinataire",
      recipientCollectsDesc:
        "Le destinataire récupère le colis à un point de livraison dans la ville de destination.",
      homeDelivery: "Livraison à domicile par le conducteur",
      homeDeliveryDesc:
        "Vous livrez le colis directement à la porte du destinataire.",
    },
    notes: {
      title: "Notes & règles",
    ...
    services: {
      ...
      free: "Gratuit",
      error:
        "Activez au moins une option de collecte et une option de livraison",
    },
    pricing: {
      ...
      errors: {
        ...
        duplicateMsg:
          "Vous avez déjà un trajet sur ce corridor pour cette date.",
      },
      toast: {
  ...
  home: {
    ...
    hero: {
      headline:
        "📦 Envoyez des colis en Tunisie depuis l'Europe.\n📮 Ou recevez de la famille à l'étranger.",
      subheadline:
        "💰 Moins cher que les courriers  •  ⚡ Plus rapide que la poste  •  ⭐ Conducteurs de confiance",
  ...
  booking: {
    ...
    collection: {
      ...
      dropoffDesc:
        "Apportez à un point de collecte partagé. Adresse et heure exactes confirmées après réservation.",
    ...
    delivery: {
      ...
      homeDesc:
        "Le conducteur livre à la porte. Adresse du destinataire requise.",
    },
    packageTypes: {
      clothing: "Vêtements",
      food: "Alimentation",
  ...
  status: {
    pending: {
      label: "En attente du conducteur",
      desc: "En attente de la confirmation du conducteur",
    },
    confirmed: {
      label: "Confirmée",
      desc: "Votre réservation est confirmée et planifiée",
    },
  ...
  tracking: {
    ...
    pendingBanner:
      "En attente de confirmation du conducteur — vous serez notifié une fois que le conducteur accepte.",
    steps: {
    ...
    escrowNote:
      "Paiement en séquestre — libéré uniquement à la livraison confirmée",
    rateTitle: "Tout est bien arrivé ?",
    rateBtn: "Évaluer le conducteur",
    printLabel: "Imprimer l'étiquette d'expédition",
    myBookings: "Mes réservations",
    insufficientCapacity:
      "Capacité insuffisante sur ce trajet. Réservation renvoyée en attente.",
